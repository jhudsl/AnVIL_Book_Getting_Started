...
Workspaces are the building blocks of projects in Terra. Inside a Workspace, you can run analyses, launch interactive tools (like RStudio, Jupyter Notebooks, and Galaxy), store data, and share results. 
