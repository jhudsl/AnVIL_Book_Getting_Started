...
Several useful tools are available to help you further analyze and understand your GCP computing costs.  Examples include

The `AnVILBilling` [Bioconductor package](http://www.bioconductor.org/packages/release/bioc/html/AnVILBilling.html)
[Google Data Studio](https://cloud.google.com/billing/docs/how-to/visualize-data)
...
To learn more about how to analyze your BigQuery cost data, see:
[]
