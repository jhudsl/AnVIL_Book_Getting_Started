...
```
    ...
    + 
```{r, echo=FALSE, fig.alt='Screenshot of an individual Google Cloud Billing Account with the dropdown menu item "Manage Billing Accounts" highlighted.'}
...
1. Enter their Google ID in the textbox. In the dropdown menu, mouse over Billing, then choose the appropriate role.
    +
```{r, echo=FALSE, fig.alt='Screenshot of the dialogue box for adding a member to a Google Cloud Billing Accounts. In the dropdown menu labeled "Select a Role", the item "Billing" and the submenu item "Billing Account Viewer" are highlighted.'}
