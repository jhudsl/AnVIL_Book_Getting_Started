...
Instead of bringing your own data, you can use existing data on AnVIL. Using the following resources can help you discover data:

### AnVIL Data Library

[**Datasets Library**](https://anvil.terra.bio/#library/datasets)

In the Dataset Library, you can find curated datasets from thousands of participants.

```{r, echo=FALSE, fig.alt='Image shows a screenshot of the Datasets Library landing page.'}
leanbuild::include_slide("https://docs.google.com/presentation/d/12QpKaLfqNHPgvF5JJyNNGOEEtkwY1exmRAUeK1BsEG8/edit#slide=id.gf5fa6f264a_0_15")
```

[**Featured Workspaces**](https://anvil.terra.bio/#library/showcase)

Remember that when you [clone a Workspace](workspaces.html#clone-workspace), AnVIL automatically creates links to the original data contained within the Data Tables. Taking a look at featured Workspaces can get you started. 

```{r, echo=FALSE, fig.alt='Image shows a screenshot of the Featured Workspaces landing page.'}
leanbuild::include_slide("https://docs.google.com/presentation/d/12QpKaLfqNHPgvF5JJyNNGOEEtkwY1exmRAUeK1BsEG8/edit#slide=id.gf5fa6f264a_0_24")
```

```{r, echo=FALSE, fig.alt='Image shows a screenshot of the Featured Workspaces tab on AnVIL. The featured tab is highlighted.'}
leanbuild::include_slide("https://docs.google.com/presentation/d/12QpKaLfqNHPgvF5JJyNNGOEEtkwY1exmRAUeK1BsEG8/edit#slide=id.gf5fa6f264a_0_7")
```

### AnVIL Dataset Catalog

[**AnVIL Dataset Catalog**](https://anvilproject.org/data)

AnVIL provides access to key NHGRI datasets, such as the CCDG (Centers for Common Disease Genomics), CMG (Centers for Mendelian Genomics), eMERGE (Electronic Medical Records and Genomics), as well as other relevant datasets. You will need to [coordinate access](https://anvilproject.org/learn/accessing-data/requesting-data-access) to controlled data.

```{r, echo=FALSE, fig.alt='Image shows a screenshot of the AnVIL Dataset Catalog website landing page.'}
leanbuild::include_slide("https://docs.google.com/presentation/d/12QpKaLfqNHPgvF5JJyNNGOEEtkwY1exmRAUeK1BsEG8/edit#slide=id.gf5fa6f264a_0_31")
```

### Gen3 Data Explorer

[**Gen3 Data Explorer and Data Commons**](https://gen3.theanvil.io/)

The Gen3 data commons provides their API for data queries and downloads, supporting cross-project analyses.

```{r, echo=FALSE, fig.alt='Image shows a screenshot of the Gen3 on AnVIL Data Explorer website landing page.'}
leanbuild::include_slide("https://docs.google.com/presentation/d/12QpKaLfqNHPgvF5JJyNNGOEEtkwY1exmRAUeK1BsEG8/edit#slide=id.gf5fa6f264a_0_40")
```
