...
leanbuild::include_slide("https://docs.google.com/presentation/d/1K8LLyP1yhDnNPtwsTQm20gXJG1m9hj-ZGwTTPGryDWc/edit#slide=id.p")
```

```{r, echo=FALSE, fig.alt="The Workspace Dashboard title is visible as subtext in the list of Workspaces."}
leanbuild::include_slide("https://docs.google.com/presentation/d/1K8LLyP1yhDnNPtwsTQm20gXJG1m9hj-ZGwTTPGryDWc/edit#slide=id.gdcee1b7ab9_1_1")
```

```{r, echo=FALSE, fig.alt="The Workspace Dashboard title is most visible from the Workspace Dashboard tab."}
leanbuild::include_slide("https://docs.google.com/presentation/d/1K8LLyP1yhDnNPtwsTQm20gXJG1m9hj-ZGwTTPGryDWc/edit#slide=id.gdcee1b7ab9_1_7")
```
...
leanbuild::include_slide("https://docs.google.com/presentation/d/1K8LLyP1yhDnNPtwsTQm20gXJG1m9hj-ZGwTTPGryDWc/edit#slide=id.gdcee1b7ab9_1_16")
```

```{r, echo=FALSE, fig.alt="The Workspace name is visible in the Workspace URL."}
leanbuild::include_slide("https://docs.google.com/presentation/d/1K8LLyP1yhDnNPtwsTQm20gXJG1m9hj-ZGwTTPGryDWc/edit#slide=id.gdcee1b7ab9_1_21")
```
