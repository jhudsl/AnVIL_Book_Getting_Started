...
<details><summary>Why use the AnVIL?</summary>

```{r echo=FALSE, results='asis'}
cow::borrow_chapter("docs/why-anvil-overview.md",
...
ottrpal::include_slide("https://docs.google.com/presentation/d/1kGxHkP0JVPNF1kla5XEqaIt1yz9s4ZbgzJ2zfL7GmTE/edit#slide=id.gde0d2ef5f6_0_1")
```
