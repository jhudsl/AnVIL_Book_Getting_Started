...
**Workspaces** are the primary unit of organization in Terra.  You can have as many Workspaces as you like.  You must have access to a Workspace to run an analysis.

**Workspace Access Levels control who is permitted to conduct billable activity in that Workspace**.  Users can be added to a Workspace as an "owner", "writer", or "reader".  Owners and writers can run analyses (which cost money), readers can only view the Workspace contents (free).

Depending on what permission levels you have been granted in Terra, you may be able to create your own Workspaces, or your team manager may need to create them for you.
...
```{r, child=c("_child_what_is_a_workspace.Rmd")}
...
```{r, child=c("_child_create_new_workspace.Rmd")}
