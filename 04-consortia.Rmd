...
::: {.fyi}
```{r, echo=FALSE, fig.alt="Large text which states 'To set up your account on AnVIL, please see the chapter for PIs and lab managers'."}
leanbuild::include_slide("https://docs.google.com/presentation/d/1dOubh-sTo5K3okZXx_7OVvUaRO58UzDn7w-pWwHD8CE/edit#slide=id.gf9c278bc2c_0_0")
```

[Go to the PIs and lab managers chapter](pis-and-lab-managers.html#overview-pis)
:::
...
::: {.fyi}
```{r, echo=FALSE, fig.alt="Large text which states 'To set up your account on AnVIL, please see the chapter for Data Analysts'."}
leanbuild::include_slide("https://docs.google.com/presentation/d/1dOubh-sTo5K3okZXx_7OVvUaRO58UzDn7w-pWwHD8CE/edit#slide=id.gf9c278bc2c_0_143")
```

[Go to the Data Analysts chapter](data-analysts.html#overview-analysts)
:::
...
::: {.fyi}
```{r, echo=FALSE, fig.alt="Large text which states 'To set up your account on AnVIL, please see the documentation for Data Submitters'."}
leanbuild::include_slide("https://docs.google.com/presentation/d/1dOubh-sTo5K3okZXx_7OVvUaRO58UzDn7w-pWwHD8CE/edit#slide=id.gf9c278bc2c_0_151")
```

[Go to the Data Submitters documentation](https://anvilproject.org/learn/data-submitters/submission-guide/data-submitters-overview)
:::
