...
a. Sign up a personal Google Cloud Account only once, where you can get started by claiming [$300 free Google credits](https://cloud.google.com/free/docs/gcp-free-tier/#free-trial).

2. DEVELOPING CONTENT

a. Include version control and visibility of course content by using GitHub. This will allow you to add content programmatically, keep track of changes, and even share your content with others outside of AnVIL.
...
b. Create separate Terra Billing Projects and Workspaces for each class based on their Google Billing Project. This will allow you to quickly stop billing expenses from accruing once the class is complete.
