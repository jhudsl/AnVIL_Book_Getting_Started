...
The following steps show you how to set up a Workspace manually. Once you are more familiar with AnVIL, you can use [ AnVILPublish ](#link to AnVILPublish) to add Workspaces from RStudio. **To start, we recommend creating one Workspace for each course**
...
Choose **Option 1** if you:  
    ...
    + Have a limited number of code notebooks and files
...
1. Change Group permissions.
    + Select "Writer" from the drop-down menu under the Group name.
